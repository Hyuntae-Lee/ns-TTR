...
* 열반사 신호: ΔR/R = (dR/dT)/R × ΔT_probe. 계수 (dR/dT)/R 은 레이저 설정의 입력값(기본 −1.4×10⁻⁴ /K, 구리 532 nm 근처 문헌값;
  프로브 파장에 따라 부호·크기가 달라짐). 신호 탭에 baseline·void 의 ΔR/R(t) 와 void 에 의한 차이를 표시.
